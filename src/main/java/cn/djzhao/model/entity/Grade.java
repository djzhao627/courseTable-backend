...
public class Grade implements Cloneable, Serializable {
     ...
     * @mbg.generated
     */
    public Grade(Integer id, String className, String classNumber, Integer dayLimit, Integer statu, String mark) {
        this.id = id;
     ...
     * @mbg.generated
     */
    public Grade withClassName(String className) {
     ...
     * @mbg.generated
     */
    public Grade withClassNumber(String classNumber) {
     ...
     * @mbg.generated
     */
    public Grade withDayLimit(Integer dayLimit) {
     ...
     * @mbg.generated
     */
    public Grade withStatu(Integer statu) {
        this.setStatu(statu);
        return this;
    }
     ...
     * @mbg.generated
     */
    public Grade withMark(String mark) {
        this.setMark(mark);
        return this;
    }
