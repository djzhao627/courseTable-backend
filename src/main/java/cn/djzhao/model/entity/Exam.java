...
public class Exam implements Cloneable, Serializable {
     ...
     * @mbg.generated
     */
    public Exam withClassName(String className) {
     ...
     * @mbg.generated
     */
    public Exam withClassNumber(String classNumber) {
     ...
     * @mbg.generated
     */
    public Exam withDayLimit(Integer dayLimit) {
     ...
     * @mbg.generated
     */
    public Exam withMark(String mark) {
        this.setMark(mark);
        return this;
    }
